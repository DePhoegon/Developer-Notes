...
/**  
 * Alternative method that returns the color directly for use in color handlers * Use this if you prefer lambda expressions in ClientProxy */@SideOnly(Side.CLIENT)  
